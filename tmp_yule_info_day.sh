...
ant -lib $ANCHOR_INFO_DIR/antlib -listener org.apache.tools.ant.listener.Log4jListener -listener com.duowan.yy.ant.ext.AntExceptionListener -f $ANCHOR_INFO_DIR/tmp_anchor_info_data.xml get_yule_info > /dev/null 2>&1

...
insert overwrite table datamine_whf_anchor_info partition(anchor_type=11) \\
...
profile,resume,agency_id,agency_name,teacher_type,speciality from datamine_whf_anchor_info where anchor_type=1"
